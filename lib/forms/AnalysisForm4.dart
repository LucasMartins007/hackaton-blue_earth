...
class AnalysisForm4 extends StatefulWidget {
  ...
  @override
  _AnalysisForm4State createState() => _AnalysisForm4State();
}

class _AnalysisForm4State extends State<AnalysisForm4> {
  @override
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "Apresenta raízes crescendo através de agregados?",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 20,
                    ),
