...
class AnalysisForm6 extends StatefulWidget {
  ...
  @override
  _AnalysisForm6State createState() => _AnalysisForm6State();
}

class _AnalysisForm6State extends State<AnalysisForm6> {
  @override
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "Apresenta amostra de solo com estrutura livre na camada superficial resultante da atividade biologica.",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 20,
                    ),
